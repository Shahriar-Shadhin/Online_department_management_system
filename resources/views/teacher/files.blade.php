...
<section>
  ...
  <div class="content">
    <form action="{{route('archive.view.teacher', session('id'))}}" method="post">
        @csrf
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        @endphp
                        <a href="{{route('archive.view-details.teacher', ['id' => session('id'), 'path' => $path, 'name' => $fileName])}}">{{$fileName}}</a>
                    </td>
                </tr>
                @endforeach
                @endif
